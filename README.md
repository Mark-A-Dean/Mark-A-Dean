...
|2015|Designed the CDW Metadata Report Suite and undertook the additional role to provide national CDW project/ workgroup support.|
...
Before my public service duty, I was a R&D chemist in the automotive industry, and I have worked in industrial warehouses organizing and managing inventory. My degree is in Biology with advanced studies in Vertebrate Zoology, Ecology, Biogeography, and taxonomy.
...
PowerShell can be learned quickly. PowerShell leans heavily on .NET, which brings C# into clearer focus for the learner. I consider PowerShell to be a polyglot. PowerShell executes from SQL Server jobs either from SSIS packages or standalone; and it readily interprets or parses other languages—especially markup languages. However, PowerShell users typically start with more basic functional programming to build familiarity. For example, I began by running _Get_-type cmdlets against **Active Directory**. Soon, I began to build custom classes and functions when special projects began to come my way. Along the way, SQL Server was pressed into service, and I found building classes, cmdlets, types, and modules accelerated capabilities.

### Ease & capability

Compare this PowerShell script with other languages like Python and C#.
...
<img src="./_assets/img/hello-world.jpg" alt="PowerShell variable $x='Hello World'. The first 5 characters are returned by $x[0..4].">
...
<img src="./_assets/img/hello-world-regex.jpg" alt="PowerShell variable $x is parsed into an object complete with a capturing group with a successful return.">
...
- 💬 Ask me about experiences with GitHub, XSD and XSLT, T-SQL, and trail races.
